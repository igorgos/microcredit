...
<%@ page import="com.controller.ContryController" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%> 
<jsp:useBean id="countryController" class="com.controller.ContryController"/>
<html>
<head>
...
Java project: <%=(1+2)%><br/>
<%
	ContryController pp =  new ContryController();
%>
Pp: <%= pp.getTime() %><br/>
